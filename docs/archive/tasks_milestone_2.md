# TASKS.md — Beetle 로드맵 및 개발 체크리스트 (Milestone 2 Archive)

이 문서는 Beetle 프로젝트의 **Milestone 2 (UI/UX 전면 개편 및 플레이 편의 기능 강화)** 완료 내역을 보관하는 아카이브 문서입니다.

---

# 🚀 Milestone 2: UI/UX & 비주얼 고도화 (User Experience & Visual Polish)

Milestone 2의 목표는 무거운 외부 라이브러리 추가 없이(바이너리 크기 < 1 MB 및 무할당/무락 오디오 불변식 유지) **선곡 탐색 편의성, 한글/일본어 다국어 지원, 인게임 플레이어블 편의성(일시정지/실시간 조절), 결과 화면 시각 보상 및 인터랙티브 키 설정**을 최고 수준으로 끌어올리는 것이었습니다.

---

## 📋 Phase 1: 타이포그래피 & 경량 다국어(CJK) 비트맵 폰트 시스템 (`beetle-render`) (Completed - `72430d5`)
...
## 📋 Phase 2: 선곡 화면(Song Select) UX 전면 개편 (`beetle-app`, `beetle-render`) (Completed - `823dcaf`)
...
## 📋 Phase 3: 인게임 일시정지(Pause) & 실시간 플레이 편의 기능 (`beetle-app`, `beetle-render`) (Completed - `5e20949`)
...
## 📋 Phase 4: 결과 화면(Stage Result) 보상 & 통계 시각화 (`beetle-render`, `beetle-core`) (Completed - `f8ff4fe`)
...
## 📋 Phase 5: 인터랙티브 1:1 키 리바인딩 & 오디오 캘리브레이션 (`beetle-app`, `beetle-render`) (Completed - `4702598`)
...
## 📋 Phase 6: 마일스톤 2 통합 검증 및 바이너리/성능 프로파일링 (Completed - `56a9f50`)
- [x] **바이너리 크기 최적화 재측정**
