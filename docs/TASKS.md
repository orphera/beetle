...
Milestone 3의 목표는 마일스톤 1 & 2를 거치며 급격히 거대해진 `beetle-render` (2,076줄 ➔ 248줄)와 `beetle-app` (1,607줄 ➔ 450줄)의 모놀리식 파일들을 **도메인 및 화면 단위 서브모듈로 깔끔하게 분리하고 응집도를 높여 유지보수성과 확장성을 극대화**하는 것입니다.
